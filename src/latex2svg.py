...
# some modifications by Matthew Anderson, 2022
...
with open("../latex/node_template.tex", 'r') as file:
...
def latex2svg(code, params=default_params, color="fff", cwd=None):
    ...
    if cwd is None:
        with TemporaryDirectory() as tmpdir:
            return latex2svg(code, params, color=color, cwd=tmpdir)
    ...
    with open(os.path.join(cwd, 'code.tex'), 'w') as f:
        f.write(document)
    ...
    with open(os.path.join(cwd, 'code.svg'), 'r') as f:
        svg = f.read()
